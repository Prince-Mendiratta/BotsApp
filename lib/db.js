const data = {
    ...
    setdp: {
        ...
        NOT_AN_IMAGE: "```Please reply to the image or caption the image you want to make the group icon.```",
        NOT_A_GROUP: "```This command is only applicable in a group chat.```",
    ...
    sticker: {
        ...
        DOWNLOADING: "```Your sticker is being downloaded. Please wait...```"
    },
    stoi: {
        ...
        DOWNLOADING: "```Your image is being downloaded. Please wait...```",
        ERROR: "```Woops, something went wrong. Try again later, or probably not with the same again...```"
    },
    tr: {
    ...
    weather: {
        DESCRIPTION: "Get information about weather of a city",
        EXTENDED_DESCRIPTION:
