const data = {
    ...
    sticker: {
        ...
        NOT_AN_IMAGE:
            "Selected Message is not an image. Please select an appropriate message.",
        NOT_A_REPLY: "Reply to an image message to proceed.",
        TAG_A_VALID_IMAGE_MESSAGE:
            "Please tag a valid image/gif message to convert to sticker.",
