const data = {
  ...
  create: {
      DESCRIPTION: "Create new group and tagged person",
      EXTENDED_DESCRIPTION: "```This module will create a new WhatsApp group and it will add the tagged person in the group.",
      NO_TEXT: "```Enter the name of the grp```",
      TAG_PERSON: "```Tag a person that should be included in group```",
      GROUP_CREATED: "```Group is successfully created```"
  },
  demote: {
